...
fun PermissionSuccessScreen(
    ...
    Box(
        ...
        Column(
            ...
            // Center Icon Container (Dark Circle with Blue Double Checkmark Icon)
            Box(
                modifier = Modifier
                    .size(105.dp)
            ...
            // Screen Title
            Text(
                text = stringResource(R.string.permission_success_title),
                color = MaterialTheme.colorScheme.onBackground,
                fontSize = 22.sp,
                fontWeight = FontWeight.Bold,
            ...
            // Paragraph 1
            Text(
                text = stringResource(R.string.permission_success_desc1),
                color = bodyTextColor,
                fontSize = 14.sp,
            ...
            // Paragraph 2
            Text(
                text = stringResource(R.string.permission_success_desc2),
                color = bodyTextColor,
                fontSize = 14.sp,
                fontWeight = FontWeight.Normal,
                textAlign = TextAlign.Center,
