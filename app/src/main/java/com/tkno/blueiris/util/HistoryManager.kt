...
object HistoryManager {
    private const val PREFS_NAME = "blueiris_history_prefs"
    ...
    fun addCleanRecord(context: Context, packageName: String, appName: String, bytesCleared: Long, timestamp: Long = System.currentTimeMillis()) {
    ...
    fun addStopRecord(context: Context, packageName: String, appName: String, timestamp: Long = System.currentTimeMillis()) {
